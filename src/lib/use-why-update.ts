export function useWhyUpdate(
  ...
  props: Record<string, any>,
  {
    ...
    onChangeFound?: (data: {
      changesObj: Record<string, { from: any; to: any; isDeepEqual: boolean; changedKeys?: string[] }>;
    }) => void;
  ...
  useEffect(() => {
    ...
    const changesObj: Record<string, { from: any; to: any; isDeepEqual: boolean; changedKeys?: string[] }> = {};
    allKeys.forEach((key) => {
